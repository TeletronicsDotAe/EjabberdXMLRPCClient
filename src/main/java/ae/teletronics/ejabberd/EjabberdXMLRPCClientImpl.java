 ...
 */
public class EjabberdXMLRPCClientImpl implements EjabberdXMLRPCClient {

    ExecutorService executorService;
    XmlRpcClient client = new XmlRpcClient();
    ResponseParser responseParser = new ResponseParser();

    public EjabberdXMLRPCClientImpl(ExecutorService executorService, XmlRpcClient client) {
